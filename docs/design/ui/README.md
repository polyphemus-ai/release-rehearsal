# The UI brief and its mockups

- **[settled-brief.md](settled-brief.md)** — the decisions. Binding in the interface and the code.
- [mockup-work-and-people.html](mockup-work-and-people.html) — Home with people, a work item and its run, chat → work, connections, a project with two people, an agent's grants, desktop.
