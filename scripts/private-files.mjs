...
export const PRIVATE = ['docs/research', 'docs/design/ui/snapshot-2026-09-12.html', 'memory', 'docs/MOVING.md', 'scripts/move-in.mjs', 'docs/brand/original', 'docs/design/ui/original-brief.md', 'docs/design/ui/addendum.md'];
